    ...
    apply: $.debounce(async () => {
      ...
      try {
        ...
        if (data.filters) {
          ...
          State.optionMap = Maps.buildOptionMap(data.filters);
          DOM.renderFilters(data.filters);
        }
  ...
  const AFS = {
    ...
    async load() {
      ...
      try {
        ...
        State.filterConfig = filtersData.filterConfig;
        ...
        if (productsData.filters) {
          State.availableFilters = productsData.filters;
