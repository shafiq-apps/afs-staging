...
var SearchLogic = {
  ...
  handleClick(e) {
    ...
    if (itemType === "suggestion") {
      const suggestion = ((_b = item.querySelector(".afs-search-dropdown__suggestion-text")) == null ? void 0 : _b.textContent) || item.textContent || "";
      if (suggestion && SearchState.activeInput) {
        SearchState.activeInput.value = suggestion;
      }
      SearchDOM.hideDropdown();
    ...
    if (item.tagName === "A") {
      ...
      const suggestion = (_c = item.querySelector(".afs-search-dropdown__suggestion-text")) == null ? void 0 : _c.textContent;
      if (suggestion && SearchState.activeInput) {
        SearchState.activeInput.value = suggestion;
        SearchLogic.debouncedSearch(suggestion);
      }
