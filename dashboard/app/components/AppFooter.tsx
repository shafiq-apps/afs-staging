          ...
          <s-stack direction="block" gap="base">
            ...
            <s-stack direction="inline" alignItems="center" justifyContent="space-between">
              <s-stack direction="inline" columnGap="small-300">
                <s-text>{CONFIG.app.name}</s-text>
                <s-text>|</s-text>
                <s-text>v{CONFIG.app.version}</s-text>
              </s-stack>
              <s-stack direction="inline" gap="base" alignItems="center" columnGap="large">
                ...
                <s-link
                  key={t("footer.links.external.link1.label")}
                  href={t("footer.links.external.link1.url")}
                  accessibilityLabel={t("footer.links.external.link1.label")}
                  target="_blank"
                >
                  <s-stack direction="inline">
                ...
                <s-link
                  key={t("footer.links.external.link2.label")}
                  href={t("footer.links.external.link2.url")}
                  accessibilityLabel={t("footer.links.external.link2.label")}
                  target="_blank"
                >
                  <s-stack direction="inline">
