...
const logger = {
  info: (message: string, data?: any) => console.log(`[webhook-products-create] ${message}`, data || ''),
  error: (message: string, data?: any) => console.error(`[webhook-products-create] ${message}`, data || ''),
};
