...
const logger = {
  info: (message: string, data?: any) => console.log(`[webhook-products-update] ${message}`, data || ''),
  error: (message: string, data?: any) => console.error(`[webhook-products-update] ${message}`, data || ''),
};
