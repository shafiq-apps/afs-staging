...
const logger = {
  info: (message: string, data?: any) => console.log(`[webhook-collections-update] ${message}`, data || ''),
  error: (message: string, data?: any) => console.error(`[webhook-collections-update] ${message}`, data || ''),
};
