...
const logger = {
  info: (message: string, data?: any) => console.log(`[webhook-collections-delete] ${message}`, data || ''),
  error: (message: string, data?: any) => console.error(`[webhook-collections-delete] ${message}`, data || ''),
};
