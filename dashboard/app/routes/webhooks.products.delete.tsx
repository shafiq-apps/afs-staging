...
const logger = createLogger({ prefix: "webhooks.products.delete" });

/**
 * Webhook handler for products/delete
 * Processes product deletion events from Shopify
...
export const action = async ({ request }: ActionFunctionArgs) => {
  try {
    ...
    logger.info('Product delete webhook received', {
      shop,
      topic,
    ...
    logger.error('Error processing products/delete webhook', {
